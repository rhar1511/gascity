...
/**
 * Get v0 city by city name bead by ID attempts diff
 */
export const getV0CityByCityNameBeadByIdAttemptsDiff = <ThrowOnError extends boolean = false>(options: Options<GetV0CityByCityNameBeadByIdAttemptsDiffData, ThrowOnError>) => (options.client ?? client).get<GetV0CityByCityNameBeadByIdAttemptsDiffResponses, GetV0CityByCityNameBeadByIdAttemptsDiffErrors, ThrowOnError>({ url: '/v0/city/{cityName}/bead/{id}/attempts/diff', ...options });
